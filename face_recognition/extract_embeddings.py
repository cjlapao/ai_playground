...
for (i, imagePath) in enumerate(imagePaths):
	...
	print("Processing image {}/{} for tag {}".format(i, len(imagePaths) -1, name))
	...
	# input_data = cv2.normalize(image, None, 0, 1, cv2.NORM_MINMAX, dtype=cv2.CV_32F)
...
f = open("face_recognition/output/embeddings.pickle", "wb")
